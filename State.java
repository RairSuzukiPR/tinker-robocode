...
public class State {
    ...
    private static final double MAX_MY_ENERGY = 100.0;
    private static final double MIN_ENEMY_ENERGY = 0.0;
    private static final double MAX_ENEMY_ENERGY = 100.0;
    ...
    public INDArray toINDArray() {
        ...
        return Nd4j.create(new double[][]{
                {normalizedMyEnergy, normalizedEnemyEnergy, normalizedEnemyBearing,
                        normalizedEnemyDistance, normalizedEnemyVelocity, normalizedDistanceToCenter, normalizedGunHeat}
        });
    }
